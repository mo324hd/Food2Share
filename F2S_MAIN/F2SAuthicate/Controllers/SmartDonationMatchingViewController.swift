...
class SmartDonationMatchingViewController: UIViewController {
    ...
    override func viewDidLoad() {
        ...
        collectorList.register(UINib(nibName: "SmartDonationMatchingCollectionHeaderUICollectionReusableView", bundle: nil), forSupplementaryViewOfKind: UICollectionView.elementKindSectionHeader, withReuseIdentifier: "HeaderView")
    ...
    func fetchCollectors(completion: @escaping([Collector]) -> Void)
    {
        ...
        let collectorPath = db.collection("users")
...
extension SmartDonationMatchingViewController: UICollectionViewDelegate, UICollectionViewDataSource, UICollectionViewDelegateFlowLayout
{
    ...
    func collectionView(_ collectionView: UICollectionView, cellForItemAt indexPath: IndexPath) -> UICollectionViewCell {
        let cell = collectorList.dequeueReusableCell(withReuseIdentifier: "CollectorInfo", for: indexPath) as! SmartDonationMatchingCollectionViewCell
    ...
    func collectionView(_ collectionView: UICollectionView, viewForSupplementaryElementOfKind kind: String, at indexPath: IndexPath) -> UICollectionReusableView
    {
        ...
        {
            let header = collectorList.dequeueReusableSupplementaryView(ofKind: kind, withReuseIdentifier: "HeaderView", for: indexPath) as! SmartDonationMatchingCollectionHeaderUICollectionReusableView
