...
class DonateToCollectorViewController: UIViewController, UICollectionViewDelegate, UICollectionViewDataSource {
    ...
    {
        DonateToCollectorDatabaseService.sharedDatabase.fetchGroup(firstTable: "users")
        {
    ...
    {
        let cell = CollectorList.dequeueReusableCell(withReuseIdentifier: "CollectorInfo", for: indexPath) as! DonateToCollectorCollectionViewCell
...
extension DonateToCollectorViewController: DonateToCollectorCollectionViewCellDelegate {
    ...
    func didTapDetails(for ID: Int)
    {
        if let selectedCollector = arrCollectors.first(where: {$0.internalID == ID})
        {
            ...
            let detailsVC = storyboard.instantiateViewController(withIdentifier: "DonateToCollectorDetailsViewController") as! DonateToCollectorDetailsViewController
...
extension DonateToCollectorViewController: distanceUpdaterDelegate
{
    func updateDistance(_ text: String) { }
}

extension DonateToCollectorViewController: CLLocationManagerDelegate {
